...
export interface ApiBookReviewBookReview extends Struct.CollectionTypeSchema {
  collectionName: 'book_reviews';
  info: {
    displayName: 'BookReview';
    pluralName: 'book-reviews';
    singularName: 'book-review';
  };
  options: {
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    taskStatus: Schema.Attribute.Integer &
      Schema.Attribute.Required &
